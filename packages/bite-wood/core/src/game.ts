...
import { handleCollisions } from './collision.js' // Tracks whether the game loop is running
...
export class Game {
  ...
  /**
   * @param stepsPerSecond - The number of times the game loop should run per second.
   */
  constructor(
    {
      stepsPerSecond = 60,
